...
public class _15211301_WeiXiao_3_HourlyEmployee extends _15211301_WeiXiao_3_Employee
{
    private double wage;
    private double hours;

    public _15211301_WeiXiao_3_HourlyEmployee()
    {
        wage=0.0;
        hours=0.0;
    }

    public _15211301_WeiXiao_3_HourlyEmployee(double w,double h,String f,String l,String s)
    {
        super(f,l,s);
        wage=w;
        hours=h;
