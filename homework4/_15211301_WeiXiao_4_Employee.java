 ...
 */
public abstract class _15211301_WeiXiao_4_Employee
{
    private String firstname;
    private String lastname;
    private final String socialSecurityNumber;

    public _15211301_WeiXiao_4_Employee()//无参数构造
    {
        firstname="f";
        lastname="l";
    ...
    public _15211301_WeiXiao_4_Employee(String f,String l,String s)//有参数构造
    {
        firstname=f;
        lastname=l;
        socialSecurityNumber=s;
