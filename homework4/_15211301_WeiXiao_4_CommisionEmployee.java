...
public class _15211301_WeiXiao_4_CommisionEmployee extends _15211301_WeiXiao_4_Employee
{
    private double commissionRate;
    private double grossSales;

    public _15211301_WeiXiao_4_CommisionEmployee()
    {
        commissionRate=0.0;
        grossSales=0.0;
    }

    public _15211301_WeiXiao_4_CommisionEmployee(double c,double g,String f,String l,String s)
    {
        super(f,l,s);
        commissionRate=c;
        grossSales=g;
